 ...
 */
public final class GravenTranslations {
    ...
    private static final List<TranslateComponent> ALL = List.of(
            ...
            AntiBot.BOT_REMOVED,
            AntiBot.FAKE_STAFF_DETECTED,
            AntiBot.DEBUG_MARKER_11,
            AntiBot.DEBUG_MARKER_1,
            AntiStaff.DETECTED
    );

    private GravenTranslations() {
    }
    ...
    public static final class Freeze {
        public static final TranslateComponent DISABLED_ON_FLAG = create("modules.freeze", "disabled_on_flag");
    ...
    public static final class AntiBot {
        public static final TranslateComponent BOT_DETECTED = create("modules.anti bot", "bot detected");
        public static final TranslateComponent BOT_REMOVED = create("modules.anti bot", "bot removed");
        public static final TranslateComponent FAKE_STAFF_DETECTED = create("modules.anti bot", "fake staff detected");
        public static final TranslateComponent DEBUG_MARKER_11 = create("modules.anti bot", "debug marker 11");
        public static final TranslateComponent DEBUG_MARKER_1 = create("modules.anti bot", "debug marker 1");

        private AntiBot() {
        }
    }

    public static final class AntiStaff {
        public static final TranslateComponent DETECTED = create("modules.anti staff", "detected");
    ...
    private static TranslateComponent create(String prefix, String suffix) {
        return GravenTranslateComponent.create(prefix, suffix);
    }
