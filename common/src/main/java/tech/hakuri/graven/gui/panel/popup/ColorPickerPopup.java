            ...
            scope.pushAbsolute(popupBounds, popup -> {
                ...
                for (int i = 0; i < channels.length; i++) {
                    ...
                    popup.slider(localTrackBounds, channelProgress, 2.5f,
                            GravenUiTheme.lumin(MD3Theme.withAlpha(MD3Theme.isLightTheme()
                                    ? MD3Theme.SURFACE_CONTAINER_HIGH : MD3Theme.SURFACE_CONTAINER_HIGHEST, 255)),
                            0.0f, 3.0f, GravenUiTheme.lumin(MD3Theme.withAlpha(channel.accent, 255)),
                            4.0f, 12.0f, 2.0f,
                            GravenUiTheme.lumin(MD3Theme.withAlpha(MD3Theme.ON_PRIMARY_CONTAINER, 255)));
