        ...
        if (editing) {
            ...
            if (activeW > 0.5f) {
                if (DropdownTheme.isOpal()) {
                    scope.roundRectHorizontalGradient(trackX, trackY, activeW, trackH, DropdownTheme.SLIDER_RADIUS,
                            GravenUiTheme.lumin(MD3Theme.PRIMARY), GravenUiTheme.lumin(MD3Theme.SECONDARY));
                } else {
