        ...
        UiTree tree = UiTree.build(scope -> {
            ...
            scope.pushAbsolute(popupBounds, popup -> {
                ...
                popup.button(localButtonBounds, localButtonBounds.height() / 2.0f,
                        GravenUiTheme.lumin(MD3Theme.lerp(MD3Theme.PRIMARY_CONTAINER, MD3Theme.PRIMARY, hover * 0.35f)),
                        buttonLabel, 0.56f, GravenUiTheme.lumin(MD3Theme.ON_PRIMARY_CONTAINER));
            });
        });
