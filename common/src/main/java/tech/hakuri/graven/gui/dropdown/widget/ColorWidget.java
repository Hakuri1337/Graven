...
public class ColorWidget extends SettingWidget<ColorSetting> {
    ...
    private void drawSaturationBrightnessPalette(UiTree.Scope scope, float localX, float localY, float width, float height, Color hueColor) {
        ...
        scope.rectGradient(localX, localY, width, height,
                GravenUiTheme.lumin(Color.WHITE), GravenUiTheme.lumin(Color.WHITE),
                GravenUiTheme.lumin(hueColor), GravenUiTheme.lumin(hueColor));
        scope.rectGradient(localX, localY, width, height,
                GravenUiTheme.lumin(new Color(0, 0, 0, 0)), GravenUiTheme.lumin(Color.BLACK),
                GravenUiTheme.lumin(Color.BLACK), GravenUiTheme.lumin(new Color(0, 0, 0, 0)));
    }
    ...
    private void drawChannelTrack(UiTree.Scope scope, Channel channel, float trackX, float trackY, float trackW, float trackH, float alphaProgress) {
        ...
        scope.roundRectHorizontalGradient(trackX, trackY, trackW, trackH, trackH * 0.5f,
                GravenUiTheme.lumin(MD3Theme.withAlpha(start, (int) (start.getAlpha() * alphaProgress))),
                GravenUiTheme.lumin(MD3Theme.withAlpha(end, (int) (end.getAlpha() * alphaProgress))));
    }
