...
public class MD3Theme {
    ...
    public static boolean isLightTheme() {
        return !isOpalTheme() && ClientSetting.INSTANCE.themeMode.is(ClientSetting.ThemeMode.Light);
    }

    public static boolean isOpalTheme() {
        return ClientSetting.INSTANCE.themePreset.is(ClientSetting.ThemePreset.Opal);
    }
    ...
    private record ThemePalette(
        ...
        private static ThemePalette forPreset(ClientSetting.ThemePreset preset, ClientSetting.ThemeMode mode) {
            return switch (preset) {
                ...
                case Opal -> paletteDark(
                        "#090909", "#0F0F0F", "#16161C", "#1E1E2D", "#29293A",
                        "#2DBFFE", "#002F42", "#123F52", "#E7F8FF",
                        "#2499CB", "#002F42", "#153C4D", "#DDF5FF",
                        "#75D7FF", "#003547", "#174A60", "#C8F1FF"
                );
            };
        }
