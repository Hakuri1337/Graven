...
public class Potions extends HudModule {
    ...
    public void render(DeltaTracker deltaTracker) {
        ...
        for (EffectInfo info : items) {
            ...
            float nameTextHeight = textHeight(nameRenderScale, "graven-default");
            float durationTextHeight = textHeight(durationRenderScale, "graven-default");
    ...
    private List<EffectInfo> collectItems(DeltaTracker delta) {
        ...
        for (Map.Entry<Holder<MobEffect>, Float> e : alphaMap.entrySet()) {
            ...
            float nameWidth = textWidth(displayName, nameRenderScale, "graven-default");
            float durationWidth = textWidth(durationStr, durationRenderScale, "graven-default");
