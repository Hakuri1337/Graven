...
public class BPS extends HudModule {
    ...
    public void render(DeltaTracker deltaTracker) {
        ...
        if (smoothNumber.getValue()) {
            ...
            float targetWidth = textWidth(targetBpsText, numberScale, "graven-default");
            ...
            float numberWidth = textWidth(bpsText, numberScale, "graven-default");
    ...
    private void drawRollingNumber(UiTree.Scope scope, float numberScale, float s) {
        ...
        for (int i = 0; i < maxLen; i++) {
            ...
            float slotWidth = 0f;
            if (prevChar != '\0') {
                slotWidth = Math.max(slotWidth, textWidth(String.valueOf(prevChar), numberScale, "graven-default"));
            }
            if (targetChar != '\0') {
