...
public class KeepSprint extends Module {
    ...
    public final DoubleSetting motion = doubleSetting("Motion", 1.0, 0.0, 1.0, 0.1, () -> mode.is(Mode.CubeCraft));
    public final IntSetting slowdown = intSetting("Slowdown", 0, 0, 100, 1, () -> !mode.is(Mode.CubeCraft));
    private final BoolSetting groundOnly = boolSetting("Ground Only", false, () -> !mode.is(Mode.CubeCraft));
    private final BoolSetting prediction = boolSetting("Prediction", false, () -> !mode.is(Mode.CubeCraft));
    private final BoolSetting reachOnly = boolSetting("Reach Only", false, () -> !mode.is(Mode.CubeCraft));
