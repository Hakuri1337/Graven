...
public class LuminRenderSystem {
    ...
    public static double toGravenMouseX(double mouseX) {
        return UiCoordinateMapper.toProjectionX(mouseX);
    }

    public static double toGravenMouseY(double mouseY) {
        return UiCoordinateMapper.toProjectionY(mouseY);
    }

    public static double toMinecraftGuiX(double gravenX) {
        return UiCoordinateMapper.toMinecraftX(gravenX);
    }

    public static double toMinecraftGuiY(double gravenY) {
        return UiCoordinateMapper.toMinecraftY(gravenY);
    }

    public static int toGravenMouseX(int mouseX) {
        return (int) Math.round(toGravenMouseX((double) mouseX));
    }

    public static int toGravenMouseY(int mouseY) {
        return (int) Math.round(toGravenMouseY((double) mouseY));
    }

    public static MouseButtonEvent toGravenMouseEvent(MouseButtonEvent event) {
